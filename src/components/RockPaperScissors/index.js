      ...
      return (
          <GameOptionsList>
              {choicesList.map(eachOption => (
                  <GameOptions Key={eachOption.id} optionDetails={eachOption}
          ...
          <GameResultViewContainer>
              <SelectedOptionsContainer>
                  ...
                  <GameUserOptionContainer>
                      ...
                      <GameParticipantChoiceImage src={gameChoiceObject.image}
                      alt="opponent choice" />
                  </GameUserOptionContainer>
              </SelectedOptionsContainer>
              <ResultText>YOU WON</ResultText>
              <PlayAgainButton type="button" onClick={this.onClickGoToGameView}>PLAY AGAIN</PlayAgainButton>
          </GameResultViewContainer>
      )
  }
                ...
                trigger={<TriggerButton type="button">Rules</TriggerButton>}>
                    {close => (
                        <PopUpBody>
                            ...
                            <CloseButton type="button" onClick={() => close()}><RiCloseLine/></CloseButton>
                        </PopUpBody>
                    )}
                </Popup>
                </PopupContainer>
